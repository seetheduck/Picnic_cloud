...
public interface FleamarketEntityRepository extends JpaRepository<FleamarketEntity,Integer> {
...
//	List<FleamarketEntity> findByMTitleContainingOrMContContaining(String input);
	...
	List<FleamarketEntity> searchByTitleOrContent(@Param("input") String input);
